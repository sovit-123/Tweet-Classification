...
with open("negative_tweets.json") as in_file, \
     open("negative_tweets_Text.csv", 'w') as out_file:
...
print "File Imported:", str("negative_tweets.json")
print "# Tweets Imported:", tweet_count
print "File Exported:", str("negative_tweets_Text.csv")
