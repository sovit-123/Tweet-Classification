...
with open("positive_tweets.json") as in_file, \
     open("positive_tweets_Text.csv", 'w') as out_file:
...
print "File Imported:", str("positive_tweets.csv")
print "# Tweets Imported:", tweet_count
print "File Exported:", str("positive_tweets_Text.csv")
